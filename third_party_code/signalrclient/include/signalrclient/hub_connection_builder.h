...
namespace signalr
{
    ...
    public:
        ...
        SIGNALRCLIENT_API hub_connection_builder& with_hub_name(const std::string& hub_name);
        SIGNALRCLIENT_API hub_connection_builder& with_query_string(const std::string& key, const std::string& value);
