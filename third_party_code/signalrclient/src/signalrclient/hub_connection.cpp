...
namespace signalr
{
    hub_connection::hub_connection(const std::string& url, std::unique_ptr<hub_protocol>&& hub_protocol, const std::string& query_string,
        ...
        : m_pImpl(hub_connection_impl::create(url, std::move(hub_protocol), trace_level, log_writer, http_client_factory, websocket_factory, query_string, skip_negotiation))
    {}
