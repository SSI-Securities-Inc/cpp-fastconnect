...
namespace signalr
{
    ...
    public:
        static std::shared_ptr<hub_connection_impl> create(const std::string& url, std::unique_ptr<hub_protocol>&& hub_protocol,
            ...
            std::function<std::shared_ptr<websocket_client>(const signalr_client_config&)> websocket_factory, const std::string& query_string, bool skip_negotiation = false);
    ...
    private:
        hub_connection_impl(const std::string& url, std::unique_ptr<hub_protocol>&& hub_protocol, trace_level trace_level,
            ...
            std::function<std::shared_ptr<websocket_client>(const signalr_client_config&)> websocket_factory, const std::string& query_string,
